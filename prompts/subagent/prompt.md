...
- To resolve yourself when finished: `bin/subagent kill --slug "$PAI_SLUG"`. The kernel will nudge your parent with `proc completed`. Do this once your task is complete and you don't expect further follow-ups; otherwise stay alive and wait for the parent's next message.
